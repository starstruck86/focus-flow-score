        ...
        jsonOptions: {
          schema: {
            ...
            properties: {
              ...
              direct_ecommerce_details: { type: 'string', description: 'What was found: name the ecommerce platform (Shopify, WooCommerce, BigCommerce, custom), list specific purchase flows observed (e.g. "Shopify checkout, product pages with Add to Cart, /cart page"). Be specific about what exists.' },
              ...
              email_sms_capture_details: { type: 'string', description: 'What was found: describe each capture method observed — popup type, footer form, inline form, SMS opt-in, incentive offered (e.g. "Exit-intent popup offering 15% off for email signup, footer newsletter form, SMS club with keyword JOIN"). List all methods found.' },
              ...
              loyalty_membership_details: { type: 'string', description: 'What was found: name the program, describe the structure (e.g. "Rewards Club — points per dollar, VIP tiers Bronze/Silver/Gold, /rewards page with earn & redeem rules"). If none found, say what was checked.' },
              ...
              category_complexity_details: { type: 'string', description: 'What was found: list ALL top-level navigation categories verbatim (e.g. "Women, Men, Kids, Home, Sale, New Arrivals, Accessories — 7 categories"). Always list them.' },
              ...
              crm_lifecycle_team_size_details: { type: 'string', description: 'What was found: list specific roles, job postings, team page mentions, or LinkedIn indicators (e.g. "Careers page lists Email Marketing Manager and CRM Specialist openings, About page mentions 200+ employees"). Explain your estimate.' },
              ...
              mobile_app_details: { type: 'string', description: 'What was found: name the app, list store links (e.g. "iOS app \'BrandName\' linked in footer via apps.apple.com/..., Google Play link also present"). If none, say what was checked.' },
              ...
              marketing_platform_details: { type: 'string', description: 'What was found: name every marketing tool/script detected with specifics (e.g. "Klaviyo signup forms embedded, klaviyo.com/onsite/js loaded, Google Analytics GA4, Meta Pixel detected, Attentive SMS pixel"). List ALL marketing tech observed.' },
              ecommerce_platform: { type: 'string', description: 'Specific ecommerce platform detected (Shopify, Shopify Plus, WooCommerce, BigCommerce, Magento, custom, etc). Empty string if none.' },
              other_tech_detected: { type: 'string', description: 'Any other notable technology, tools, or platforms detected on the site (e.g. "Yotpo reviews, Gorgias chat widget, Afterpay/Klarna BNPL, Nosto personalization"). List everything notable.' },
          ...
          prompt: `Analyze this website for a B2B sales rep selling marketing automation / lifecycle marketing software to ${accountName || 'this company'}. For EVERY signal, report exactly what you discovered — name specific platforms, programs, tools, page elements, and URLs. The rep needs to walk into a meeting knowing exactly what this company uses and does. Be thorough and specific.`,
        },
