...
import {
  createScheduleDailyPlanHandler,
  scheduleDailyPlanCorsHeaders as corsHeaders,
} from "./handler.ts";

async function handleScheduleDailyPlanRequest() {
  try {
...
serve(createScheduleDailyPlanHandler(handleScheduleDailyPlanRequest));
