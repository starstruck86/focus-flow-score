...
2. IMPLICATION (20pts): Did they help the buyer see the downstream impact — revenue, risk, time, competitive?
...
2. BUSINESS FRAMING (25pts): Did they frame everything in outcomes the exec cares about — revenue, margin, risk, speed?
...
5. STRATEGIC RELEVANCE (10pts): Did they connect to the exec's stated priority or known initiative?
6. CONTROL (10pts): Did they end with a clear, executive-appropriate ask — not a passive "thoughts?"

COMMON MISTAKES (pick the most relevant):
- too_long: Would take more than 30 seconds to deliver — immediate fail with execs
...
const COACHING_TONE: Record<string, string> = {
  objection_handling: `Coach like a sharp sales leader doing a post-call debrief. Be direct about what worked and what didn't. Name the specific moment they lost control or missed an opening. Don't soften — reps need clarity, not comfort.`,
...
- 40-54: Below average. Missed the real issue or lost control.
...
${retryCount > 0 ? `This is retry #${retryCount}. If the rep improved, acknowledge specifically what changed. If they didn't improve, be direct about it.` : ''}

CRITICAL RULES FOR YOUR RESPONSE:
- "feedback": 2 sentences max. First sentence: what they did well or attempted. Second sentence: the specific gap or miss. Reference their approach when it's useful for learning, but do not force awkward quoting. Be natural and direct.
- "improvedVersion": Write the EXACT words a top rep would say OUT LOUD in this moment. It should sound like natural speech — something you'd actually hear a great rep say on a real call. Not polished marketing copy. Not a framework recitation. Real spoken words, 3-5 sentences max.
- "topMistake": one value from the common mistakes list above.
...
Respond with ONLY valid JSON:
{
  ...
  "improvedVersion": "The exact words a top rep would say out loud. Natural, specific, powerful."
}`;
