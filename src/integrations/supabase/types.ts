  ...
  public: {
    Tables: {
      ...
      account_product_ownership: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_product_ownership_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "account_product_ownership_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "account_product_ownership_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      ki_annotations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ki_annotations_ki_id_fkey"
            columns: ["ki_id"]
            isOneToOne: false
            referencedRelation: "knowledge_items"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ki_annotations_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "branch_readiness"
            referencedColumns: ["user_id"]
