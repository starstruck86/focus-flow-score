...
function deriveSkillsFromChapter(chapter: string): SkillFocus[] {
  const map: Record<string, SkillFocus[]> = {
    ...
    'Stakeholder Navigation': ['discovery', 'qualification'],
    Stakeholder_Navigation: ['discovery', 'qualification'],
    ...
    executive_engagement: ['executive_response'],
    // ── Previously unmapped ──
    coaching: ['executive_response'],
    call_coaching: ['discovery'],
    general: ['objection_handling', 'discovery'],
    General: ['objection_handling', 'discovery'],
    personas: ['discovery', 'qualification'],
    hiring: ['executive_response'],
    hiring_top_talent: ['executive_response'],
    'Hiring Top Talent': ['executive_response'],
    onboarding: ['executive_response'],
    competitors: ['objection_handling'],
    pipeline_generation: ['deal_control'],
    pipeline_diagnosis: ['deal_control'],
    deal_reviews: ['deal_control'],
    deal_inspection: ['deal_control'],
    deal_management: ['deal_control'],
    next_steps: ['deal_control'],
    champion_enablement: ['deal_control'],
    champion_building: ['deal_control'],
    account_planning: ['deal_control'],
    account_management: ['deal_control'],
    territory_planning: ['deal_control'],
    territory_management: ['deal_control'],
    forecasting: ['deal_control'],
    forecast: ['deal_control'],
    team_selling: ['deal_control'],
    strategic_planning: ['executive_response'],
    product: ['executive_response'],
    product_feedback: ['executive_response'],
    social_selling: ['objection_handling', 'deal_control'],
    call_opening: ['objection_handling', 'deal_control'],
    rapport_building: ['discovery'],
    presenting_price: ['objection_handling'],
    rfp_strategy: ['objection_handling'],
    managing_scope: ['deal_control'],
    meeting_strategy: ['discovery'],
    meeting_strategies: ['discovery'],
    meeting_management: ['discovery'],
    meeting_facilitation: ['discovery'],
    sales_meetings: ['discovery'],
    on_site_meetings: ['discovery'],
    in_person_meetings: ['discovery'],
    customer_success: ['discovery'],
    retention: ['discovery'],
    building_trust: ['discovery'],
    preparation: ['objection_handling', 'deal_control'],
    running_your_sales_day: ['deal_control'],
    running_sales_day: ['deal_control'],
    time_management: ['deal_control'],
    self_management: ['deal_control'],
    mindset: ['deal_control'],
    re_engagement: ['deal_control'],
    management: ['executive_response'],
    team_management: ['executive_response'],
    sales_management: ['executive_response'],
    sales_leadership: ['executive_response'],
    training: ['executive_response'],
    sales_process: ['deal_control'],
    career_development: ['executive_response'],
    career_pathing: ['executive_response'],
    career_growth: ['executive_response'],
    developing_people: ['executive_response'],
    developing_your_people: ['executive_response'],
    SDR_management: ['executive_response'],
    sdr_management: ['executive_response'],
    sales_enablement: ['executive_response'],
    skill_development: ['executive_response'],
    compensation: ['executive_response'],
    ai_enablement: ['executive_response'],
    strategy: ['executive_response'],
  };
