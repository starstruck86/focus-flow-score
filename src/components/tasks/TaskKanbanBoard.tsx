...
export function TaskKanbanBoard({ tasks, selectedIds, onToggleSelect }: TaskKanbanBoardProps) {
  ...
  return (
    <div className="flex gap-3 overflow-x-auto pb-4 -mx-2 px-2 snap-x snap-mandatory min-h-[200px]">
      {COLUMN_STATUSES.map(status => {
        ...
        return (
          ...
          >
            ...
            {/* Cards */}
            <div className={`flex-1 overflow-y-auto p-2.5 space-y-2.5 min-h-[100px] ${SHELL.viewport.maxHeight(14)}`}>
              {colTasks.length === 0 ? (
                <div className={cn(
