 ...
 * Shows turn-by-turn scores, arc-level verdict, and flow control analysis.
 */

import { Card, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { TrendingUp, TrendingDown, Minus, Shield, Target, AlertTriangle, Layers } from 'lucide-react';
...
export function ConversationFlowCard({ arc, turnResults, arcScore }: ConversationFlowCardProps) {
  return (
