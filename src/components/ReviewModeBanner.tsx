...
export function ReviewModeBanner() {
  ...
  return (
    <div
      ...
      className="sticky top-[env(safe-area-inset-top)] z-[60] flex items-center justify-center gap-2 bg-amber-500 text-amber-950 text-xs font-semibold py-1.5 px-4 select-none"
    >
