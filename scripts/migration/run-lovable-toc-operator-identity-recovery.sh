...
readonly STAGE='toc_operator_identity_recovery_launcher'
readonly STARTUP_DIAGNOSTIC='{"diagnostic_version":1,"reason":"startup_environment_invalid","stage":"toc_operator_identity_recovery_launcher","status":"failed"}'
readonly TTY_DIAGNOSTIC='{"diagnostic_version":1,"reason":"tty_invalid","stage":"toc_operator_identity_recovery_launcher","status":"failed"}'
...
readonly driver="$script_dir/recover-lovable-toc-operator-identity.py"
